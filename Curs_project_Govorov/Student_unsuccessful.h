...
namespace CursprojectGovorov {
	...
	/// <summary>
	/// Сводка для MyFormStudentUnsucsessful
	/// </summary>
	public ref class MyFormStudentUnsucsessful : public System::Windows::Forms::Form
	{
	public:
		MyFormStudentUnsucsessful(void)
		{
			InitializeComponent();
			//
		...
		MyFormStudentUnsucsessful(System::Windows::Forms::Form^ pForm)
		{
			InitializeComponent();
	...
	private: System::Windows::Forms::DataGridViewTextBoxColumn^ UnsucsessfulSubject;
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->dataGridViewStudent->Columns->AddRange(gcnew cli::array< System::Windows::Forms::DataGridViewColumn^  >(5) {
				this->id,
					this->Name_student, this->Surname_student, this->Group, this->UnsucsessfulSubject
			});
			...
			// UnsucsessfulSubject
			// 
			this->UnsucsessfulSubject->HeaderText = L"Незданных предметов";
			...
			this->Name = L"MyFormStudentUnsucsessful";
			this->ShowIcon = false;
